...
class CreateGroupModel: ObservableObject {
  ...
  @Published var debouncedPublicId = ""
                ...
                Section {
                  HStack(spacing: 1) {
                    ...
                    TextField("id", text: $createGroupModel.publicId)
                      ...
                      .validateMinLength(
                        value: $createGroupModel.debouncedPublicId, isValid: $isPublicIdValid,
                        minLength: 5
                      )
                      ...
                      Text("")
                        .background(
                          RoundedRectangle(cornerRadius: 8)
                            .stroke(
                              createGroupModel.isCheckingPubicAvailability
                  ...
                  } else if createGroupModel.debouncedPublicId.count != 0
                    && !createGroupModel.lastPublicIdAvailability
                  {
                    withAnimation {
                  ...
                  EmptyView()
                    .onChange(
                      of: createGroupModel.debouncedPublicId,
                      {
                        if createGroupModel.debouncedPublicId.count >= 5 {
                          createGroupModel.isCheckingPubicAvailability = true
                          walkerApp.wsMessageSender.checkPublicIdAvailability(
                            publicId: createGroupModel.debouncedPublicId)
                        }
                      })
